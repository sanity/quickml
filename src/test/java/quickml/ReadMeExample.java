...
public class ReadMeExample {
    ...
    public static void main(String[] args) {
        ...
        instances.add(new InstanceImpl<AttributesMap, Serializable>(attributes, "overweight"));
        attributes = AttributesMap.newHashMap() ;
        attributes.put("height",75);
        attributes.put("weight", 168);
        attributes.put("gender", "female");
        instances.add(new InstanceImpl<AttributesMap, Serializable>(attributes, "healthy"));
        attributes = AttributesMap.newHashMap() ;
        attributes.put("height",74);
        attributes.put("weight", 143);
        attributes.put("gender", "male");
        instances.add(new InstanceImpl<AttributesMap, Serializable>(attributes, "underweight"));
        attributes = AttributesMap.newHashMap() ;
