...
public class RandomForestBuilderBuilder implements PredictiveModelBuilderBuilder<RandomForest, RandomForestBuilder> {
    ...
    public RandomForestBuilder buildBuilder(Map<String, Object> predictiveModelParameters){
        TreeBuilder treeBuilder = new TreeBuilder().maxDepth((Integer)predictiveModelParameters.get("maxDepth")).ignoreAttributeAtNodeProbability((Double)predictiveModelParameters.get("ignoreAttributeAtNodeProbability"));
