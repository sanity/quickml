...
import static quickml.supervised.classifier.tree.TreeBuilder.MISSING_VALUE;


public class ClassificationCounter extends DataSummerizer implements Serializable {
    ...
    public static Pair<ClassificationCounter, List<AttributeValueData>> getSortedListOfAttributeValuesWithClassificationCounters(
