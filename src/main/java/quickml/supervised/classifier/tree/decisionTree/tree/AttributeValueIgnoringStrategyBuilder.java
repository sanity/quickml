 ...
 */
public interface AttributeValueIgnoringStrategyBuilder<T extends InstanceWithAttributesMap, DS extends DataSummerizer, A extends AttributeValueIgnoringStrategy<DS>> {
