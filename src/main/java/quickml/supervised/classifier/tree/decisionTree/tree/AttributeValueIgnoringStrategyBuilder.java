 ...
 */
public interface AttributeValueIgnoringStrategyBuilder<T extends InstanceWithAttributesMap, DS extends GroupStatistics, A extends AttributeValueIgnoringStrategy<DS>> {
