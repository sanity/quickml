...
public class NumericDistributionSampler {
    ...
    public NumericDistributionSampler(List<Instance<AttributesMap>> instances, int samplesToDraw, String attribute, int numBins) {
        samplesToDetermineBinWidths = instances.size();
        updateDistributionSampler(instances, samplesToDraw, attribute, numBins);
    }

    public NumericDistributionSampler(List<Instance<AttributesMap>> instances, double percentageOfAllSamplesToUse, String attribute, int numBins) {
        samplesToDetermineBinWidths = instances.size();
        updateDistributionSampler(instances, percentageOfAllSamplesToUse, attribute, numBins);
    }

    public NumericDistributionSampler(List<Instance<AttributesMap>> instances, int samplesToDraw, String attribute, int numBins, int samplesToDetermineBinWidths) {
        this.samplesToDetermineBinWidths = Math.min(samplesToDetermineBinWidths, instances.size());
        updateDistributionSampler(instances, samplesToDraw, attribute, numBins);
    }

    public NumericDistributionSampler(List<Instance<AttributesMap>> instances, double percentageOfAllSamplesToUse, String attribute, int numBins, int samplesToDetermineBinWidths) {
        this.samplesToDetermineBinWidths = Math.min(samplesToDetermineBinWidths, instances.size());
        updateDistributionSampler(instances, percentageOfAllSamplesToUse, attribute, numBins);
    }


    public void updateDistributionSampler(List<Instance<AttributesMap>> newInstances, double percentageOfAllSamplesToUse, String attribute, int numBins) {
    ...
    public void updateDistributionSampler(List<Instance<AttributesMap>> newInstances, int samplesToDraw, String attribute, int numBins) {
        updateHistogramOfCountsForValues(newInstances, samplesToDraw, attribute, numBins);
        createAttributeValueRangeMap();
    }
    ...
    private void updateSplitList(double[] splitList, List<Instance<AttributesMap>> instances, String attribute, int i) {
    ...
    private void updateHistogramOfCountsForValues(List<Instance<AttributesMap>> instances, int samplesToDraw, String attribute, int numBins) {
        Number val;
