...
public class DTCatBranch extends DTBranch  {
    ...
    public DTCatBranch(DTBranch parent, final String attribute, final Set<Object> inSet, double probabilityOfTrueChild, double score, ClassificationCounter aggregateStats ) {
