 ...
 */
public class DTreeNClassCatBranchFinder extends BranchFinder<ClassificationCounter, DTNode> {

    public DTreeNClassCatBranchFinder(Collection<String> candidateAttributes, BranchingConditions<ClassificationCounter, DTNode> branchingConditions, Scorer<ClassificationCounter> scorer, AttributeValueIgnoringStrategy<ClassificationCounter> attributeValueIgnoringStrategy, AttributeIgnoringStrategy attributeIgnoringStrategy, BranchType branchType) {
        super(candidateAttributes, branchingConditions, scorer, attributeValueIgnoringStrategy, attributeIgnoringStrategy, branchType);
    }

    @Override
    public Optional<? extends Branch<ClassificationCounter, DTNode>> getBranch(Branch<ClassificationCounter, DTNode> parent,
