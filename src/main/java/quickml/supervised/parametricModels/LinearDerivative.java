...
import quickml.supervised.classifier.logisticRegression.SparseRegressionInstance;
 ...
 */
public class LinearDerivative implements OptimizableCostFunction<SparseRegressionInstance> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LinearDerivative.class);

    public LinearDerivative executorThreadCount(int executorThreadCount) {
    ...
    public LinearDerivative maxGradientNorm(double maxGradientNorm) {
        this.maxGradientNorm = maxGradientNorm;
        return this;
    }
    public LinearDerivative minInstancesForParrellization(int minInstancesForParrellization) {
        this.minInstancesForParrellization = minInstancesForParrellization;
        return this;
    }

    public LinearDerivative expectedFractionOfFeaturesToUpdatePerWorker(double expectedFractionOfFeaturesToUpdatePerWorker) {
        this.expectedFractionOfFeaturesToUpdatePerWorker = expectedFractionOfFeaturesToUpdatePerWorker;
        return this;
    }

    public LinearDerivative sparseParallelization(boolean sparseParallelization) {
    ...
    public void updateBuilderConfig(final Map<String, Serializable> config) {
        ...
        @Override
    public  double computeCost(List<? extends SparseRegressionInstance> instances, double[] weights, double minPredictedProbablity, double ridge, double lasso) {
        double cost = 0.0;
...
//update SparseLinearSGD to return a list at the correct mini-batch location
    @Override
    public void updateGradient(final List<? extends SparseRegressionInstance> sparseClassifierInstances, final double[] fixedWeights) {
