...
// */
//public class RidgeLinearModelBuilder implements PredictiveModelBuilder<LinearModel, RidgeInstance> {
//
...
//
//    @Override
//    public LinearModel buildPredictiveModel(Iterable<RidgeInstance> trainingData) {
//
...
//        return new LinearModel(modelCoefficients, header, includeBiasTerm);
//    }
//
//
