...
import quickml.decisionTree.branchFinders.branchFinderBuilders.DTBinaryCatBranchFinderBuilder;
import quickml.decisionTree.branchFinders.branchFinderBuilders.DTBranchFinderBuilder;
import quickml.decisionTree.branchFinders.branchFinderBuilders.DTCatBranchFinderBuilder;
import quickml.supervised.tree.dataExploration.DTreeTrainingDataSurveyor;
import quickml.decisionTree.branchFinders.branchFinderBuilders.DTNumBranchFinderBuilder;
import quickml.decisionTree.branchingConditions.DTBranchingConditions;
import quickml.decisionTree.reducers.*;
import quickml.decisionTree.valueCounters.ClassificationCounterProducer;
...
import static quickml.decisionTree.DecisionTreeBuilder.*;
...
public class DTreeContextBuilder<I extends ClassifierInstance> extends TreeContextBuilder<I, ClassificationCounter, DTNode> {
    ...
    public void branchFinderBuilders(List<? extends BranchFinderBuilder<ClassificationCounter, DTNode>> branchFinderBuilders) {
