...
public class InstancesToCsvWriter {
    ...
    public static void writeInstances(List<? extends Instance<AttributesMap>> instances, String filePath) {
    ...
    private static String[] getHeader(List<? extends Instance<AttributesMap>> instances) {
    ...
    private static String[] instanceToRow(Instance<AttributesMap> instance, String [] header) {
